  ...
  render() {
    return (
      <View style={styles.container}>
        <CommonCell
          leftIcon = 'https://ws1.sinaimg.cn/large/006pJUwqgy1g1tnjdz746j305k05k0sp.jpg'
          leftTitle = '猜你喜欢'
        />
        {/*列表*/}
        <ListView
    ...
    return(
      <TouchableOpacity>
        <View style={styles.listViewStyle}>
          {/*左边*/}
          <Image source={{uri:url.search('w.h')==-1?url:url.replace('w.h', '120.90')}} style={styles.imageViewStyle}/>
          {/*右边*/}
